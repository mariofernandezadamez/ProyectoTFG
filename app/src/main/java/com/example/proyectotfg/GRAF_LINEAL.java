...
public class GRAF_LINEAL extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_graf_lineal);
    ...
    public void rellenar_grafico_linear() {
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://192.168.73.1/bbdd_tfg/grafico_lineal_1.php", new Response.Listener<String>() {
            @Override
    ...
    public void cambiar_graf_lineal_2(View view){
        Intent i = new Intent(this, GRAF_LINEAL_2.class);
        startActivity(i);
    }
}
