...
public class GRAF_BARRAS_PLANTAS extends AppCompatActivity {
    ...
    public void rellenar_grafico_barras_plantas(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://192.168.73.1/bbdd_tfg/grafico_barras_plantas.php?num_planta=1", new Response.Listener<String>() {
            @Override
        ...
        StringRequest stringRequest2 = new StringRequest(Request.Method.GET, "http://192.168.73.1/bbdd_tfg/grafico_barras_plantas.php?num_planta=2", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
        ...
        StringRequest stringRequest3 = new StringRequest(Request.Method.GET, "http://192.168.73.1/bbdd_tfg/grafico_barras_plantas.php?num_planta=3", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
